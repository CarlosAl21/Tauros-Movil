...
export const taurosSchedules: TaurosSchedule[] = [
  {
    ...
    apertura: "05:30",
    cierre: "22:00",
    detalle: "Horario fuerte para pierna y tren superior",
    destacado: true,
  },
  {
    dia: "Martes",
    apertura: "05:30",
    cierre: "22:00",
    detalle: "Clases funcionales y cardio controlado",
  },
  {
    dia: "Miercoles",
    apertura: "05:30",
    cierre: "22:00",
    detalle: "Horario regular con área de pesas completa",
  },
  {
    dia: "Jueves",
    apertura: "05:30",
    cierre: "22:00",
    detalle: "Sesiones de técnica y movilidad",
  },
  {
    dia: "Viernes",
    apertura: "05:30",
    cierre: "22:00",
    detalle: "Pico de asistencia por la tarde",
  },
  {
    dia: "Sabado",
    apertura: "07:00",
    cierre: "18:00",
    detalle: "Horario corto para planes express",
  },
  {
    dia: "Domingo",
    apertura: "Cerrado",
    cierre: "Cerrado",
    detalle: "Descanso y mantenimiento del gimnasio",
  },
];
...
export const taurosPlans: TaurosPlan[] = [
  {
    ...
    descripcion:
      "Rutina de volumen controlado con enfoque en técnica y consistencia diaria.",
        ...
        ejercicios: [
          {
            ...
            repeticiones: "8 a 10",
            carga: "0.0 kg",
            notas: "Subir la carga solo si la técnica se mantiene",
            completado: false,
          },
          {
            ...
            repeticiones: "12",
            carga: "20.0 kg",
            notas: "Pausa de 1 segundo en la bajada",
            completado: true,
          },
        ],
      },
        ...
        ejercicios: [
          {
            ...
            repeticiones: "10 a 12",
            carga: "12.5 kg",
            notas: "No bloquear codos al final",
            completado: false,
          },
          {
            ...
            repeticiones: "10",
            carga: "18.0 kg",
            notas: "Descenso lento y controlado",
            completado: false,
          },
        ],
      },
        ...
        ejercicios: [
          {
            ...
            repeticiones: "10",
            carga: "18.0 kg",
            notas: "Pecho arriba y abdomen firme",
            completado: false,
          },
          {
            exerciseId: "peso-muerto-rumano",
            ...
            repeticiones: "12",
            carga: "20.0 kg",
            notas: "Mantener tensión en isquiotibiales",
            completado: false,
          },
        ],
      },
        ...
        ejercicios: [
          {
            ...
            repeticiones: "15",
            carga: "Ligera",
            notas: "Solo técnica y rango completo",
            completado: false,
          },
        ],
      },
  ...
  },
  {
    ...
    descripcion:
      "Bloque para usuarios con mayor experiencia y control de cargas.",
        ...
        ejercicios: [
          {
            ...
            repeticiones: "6 a 8",
            carga: "22.5 kg",
            notas: "Si falla la técnica, bajar 10%",
            completado: false,
          },
        ],
      },
...
export const taurosSuggestions: TaurosSuggestion[] = [
  {
    ...
    contenido:
      "Registra la carga de cada serie para ver tu progreso real al final de la semana.",
  },
  {
    id: "sug-rutina-2",
    tipoEntidad: "RUTINA",
    ...
    actividad: "Entrenamiento B",
    contenido:
      "Si faltas un día, completa el siguiente sin duplicar volumen para no sobrecargarte.",
  },
  {
    id: "sug-ej-1",
    ...
    contenido:
      "Ajusta el asiento para que la rodilla no cierre demasiado en la parte baja.",
  },
  {
    id: "sug-ej-2",
    tipoEntidad: "EJERCICIO",
    ...
    contenido:
      "Mantén las escápulas retraídas y evita despegar la espalda del respaldo.",
  },
  {
    id: "sug-evento-1",
    tipoEntidad: "EVENTO",
    ...
    contenido:
      "Llega 15 minutos antes para reservar espacio y calentar correctamente.",
  },
  {
    id: "sug-evento-2",
    tipoEntidad: "EVENTO",
    ...
    contenido:
      "Lleva tu libreta para registrar ajustes de máquinas y recomendaciones del coach.",
  },
];
...
export function getSuggestionsByType(type: SuggestionType, entityId?: string) {
  return taurosSuggestions.filter(
    (item) =>
      item.tipoEntidad === type && (!entityId || item.entidadId === entityId),
  );
}
