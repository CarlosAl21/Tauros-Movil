...
import { TaurosCard, TaurosInputButton, TaurosScreen, TaurosStat } from '@/components/tauros-ui';
import { useTaurosBackend } from '@/lib/tauros-backend';
import { mapBackendEvents, mapBackendPlans, pickLatestAssignedPlan } from '@/lib/tauros-mappers';
...
const styles = StyleSheet.create({
  ...
  motivationText: { color: '#f4ae1a', fontSize: 14, fontWeight: '700', lineHeight: 20 },
